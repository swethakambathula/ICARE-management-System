class AttachmentsController < ApplicationController
  ...
  def create
    ...
    if @attachment.save
      ...
      redirect_to my_patient_path(@patient_record), notice: "Attachment added successfully."
    else
      redirect_to my_patients_path, alert: @attachment.errors.full_messages.join(", ")
    end
  end
  ...
  def destroy
    if @attachment.destroy
      redirect_to my_patient_path(@patient_record), notice: "Attachment destroyed successfully."
    else
      redirect_to my_patients_path, alert: @attachment.errors.full_messages.join(", ")
    end
  end
